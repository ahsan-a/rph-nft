...
import { getUser, useDiscordLogin } from '~/composables/discord';

const user = await getUser();
</script>

<template>
	<div class="fixed block w-full">
